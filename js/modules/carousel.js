import { prefersReducedMotion, onReduceMotionPreferenceChange } from './utils.js';
import { openHeroLightbox, setCarouselRefs, updateHeroLightboxNavState } from './lightbox.js';
...
export function initCarousel() {
  ...
  // Register with lightbox module
  setCarouselRefs({
    pauseAutoplay: stopHeroCarouselAutoplay,
    resumeAutoplay: startHeroCarouselAutoplay,
    triggers: heroCarouselLightboxTriggers,
    setSlide: setHeroCarouselSlide,
    getIndex: heroCarouselGetIndex,
    carouselEl: heroCarouselEl,
  });
